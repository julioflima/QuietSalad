...
const BodyFront: React.FC<any> = props => {
  ...
  return (
    <Svg
      ...
      <G fill="#fff">
        <Path
          onPress={() => handleOnPress('deltoidTwo')}
          id="deltoidTwo"
        ...
        />
        <Path
          onPress={() => handleOnPress('pectoralis')}
          id="pectoralis"
        ...
        />
        <Path
          onPress={() => handleOnPress('pectineus')}
          id="pectineus"
        ...
        />
        <Path
          onPress={() => handleOnPress('adductor')}
          id="adductor"
